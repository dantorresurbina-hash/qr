...
// Subcomponente Modal extraído y optimizado V6.7
const PedidoDetailModal = ({ pedido, onClose, onUpdateStatus, isUpdating }) => {
        ...
        <div className="bg-gradient-to-r from-indigo-700 to-indigo-600 p-8 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div>
              ...
              <h2 className="text-3xl font-black leading-tight tracking-tighter">{pedido.nombre_proyecto}</h2>
